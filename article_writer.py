...
def build_gemini_article_prompt(
    ...
    system_message = (
        ...
        "  5. KEYPHRASE DENSITY: Use the exact keyphrase 3-6 times throughout the article (0.5-2.0%). Do NOT force it into every paragraph.\n"
        ...
        "  10. SENTENCE LENGTH (CRITICAL): Keep at least 75% of sentences UNDER 20 words.\n"
        "     - Split long compound sentences at conjunctions (and, but, while, which)\n"
        "     - Turn subordinate clauses into separate sentences\n"
        "     - Remove unnecessary qualifiers and filler phrases\n"
        "     - BAD: 'The fire broke out at the station on Monday afternoon and was quickly extinguished by emergency services who arrived within minutes.' (25 words)\n"
        "     - GOOD: 'The fire broke out on Monday afternoon. Emergency services arrived within minutes and extinguished the blaze.' (2 sentences, 7+10 words)\n"
        "  11. TRANSITION WORDS: Use in 30-45% of sentences (NOT more than 45%!)\n"
        "     - Prefer varied connectors: however, meanwhile, in contrast, in addition, for example, notably\n"
        "     - Use 'therefore' and 'consequently' sparingly (ideally zero or one each)\n"
        ...
        "     - BAD (robotic): 'Consequently, X happened. Furthermore, Y occurred. Moreover, Z followed. Additionally, W emerged.'\n"
        "     - GOOD (natural): 'X happened. Consequently, Y occurred. Z followed shortly after. Moreover, W emerged.'\n"
        "     - Mix transition-word openers with subject-first openers for natural flow\n"
        "  12. Use subheadings (H2) every 250-300 words\n"
        "  13. PASSIVE VOICE (CRITICAL): Use in FEWER THAN 10% of sentences. Always prefer active voice.\n"
        "     - BAD (passive): 'The station was evacuated by firefighters.' → GOOD (active): 'Firefighters evacuated the station.'\n"
        "     - BAD (passive): 'The report was published by the council.' → GOOD (active): 'The council published the report.'\n"
        "     - BAD (passive): 'Residents were told to stay indoors.' → GOOD (active): 'Authorities told residents to stay indoors.'\n"
        "     - BAD (passive): 'The decision was made after a meeting.' → GOOD (active): 'Officials made the decision after a meeting.'\n"
        "     - BAD (passive): 'The building has been described as unsafe.' → GOOD (active): 'Inspectors described the building as unsafe.'\n"
        "     - RULE: If the subject is unknown, name it (police, officials, authorities, residents, organisers)\n\n"
        "🔵 WRITING QUALITY (READ CAREFULLY):\n"
        "  - Write like a journalist, NOT like an SEO robot. The reader should never feel the article was machine-generated.\n"
        "  - Vary sentence openers: mix subject-first ('The council approved...'), time-first ('On Monday,...'), place-first ('In Barcelona,...'), and transition-word openers\n"
        "  - Do NOT start every sentence or every other sentence with a transition word. Maximum 2 consecutive transition-word openers.\n"
        "  - Do NOT repeat the keyphrase in every paragraph. Use it in intro, one H2, and 1-2 body paragraphs — NOT everywhere.\n"
        "  - Do NOT put the keyphrase in every H2 heading. Only ONE H2 should contain it.\n"
        "  - Use specific details, numbers, names, and quotes to make the article feel grounded and reported.\n"
        "  - Vary paragraph length: mix short punchy paragraphs (1-2 sentences) with medium ones (3-4 sentences).\n\n"
        "  - Keep vocabulary accessible for a broad audience; prefer plain English over jargon-heavy wording.\n\n"
        "LINKING RULES:\n"
        ...
        "  - NEVER link to entities portrayed NEGATIVELY in the article (criminals, defendants, fraudsters)\n"
        "  - Link labels must accurately describe the target — don't label fgc.cat as 'Generalitat of Catalonia' (FGC is a rail company, not the government)\n"
    )
    ...
    user_message = (
        ...
        "6b. TRANSITION WORDS (TARGET: 30-45% OF SENTENCES):\n"
        "   - Use transition words naturally, but avoid formulaic openers\n"
        ...
        "   - Mix sentence openings (subject/time/place/transition), do not force transition-first structure\n"
        "   - Use 'therefore' and 'consequently' sparingly and avoid repeating either in the same section\n\n"
